    ...
    property var items: [
        ...
        },
        {
            ...
            subItems: [
                ...
                // `ic_fluent_slider_20_regular` is not present in FluentSystemIcons-Index.js.
                // Use a close existing icon to avoid missing glyphs.
                { title: qsTr("Slider"), page: "SliderPage", icon: "ic_fluent_options_20_regular" },
        ...
        },
        {
            ...
            subItems: [
                ...
                // `ic_fluent_spinner_off_20_regular` is not present in FluentSystemIcons-Index.js.
                { title: qsTr("BusyIndicator"), page: "BusyPage", icon: "ic_fluent_spinner_ios_20_regular" },
