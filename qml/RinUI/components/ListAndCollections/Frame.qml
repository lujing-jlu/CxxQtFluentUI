...
Frame {
    ...
    property color color: themeManager.currentTheme.colors.cardColor
    property alias radius: background.radius
    property color borderColor: themeManager.currentTheme.colors.cardBorderColor
    property int borderWidth: themeManager.currentTheme.appearance.borderWidth
