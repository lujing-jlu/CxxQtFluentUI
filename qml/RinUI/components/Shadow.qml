...
DropShadow {
    ...
    anchors.fill: source
    horizontalOffset: 0
    verticalOffset: themeManager.currentTheme.shadows[style].offsetY
    radius: themeManager.currentTheme.shadows[style].blur
    color: themeManager.currentTheme.shadows[style].color
    samples: 1 + radius * 2
    // source: sourceItem
    cached: true
}
...
//     property int blurRadius: themeManager.currentTheme.shadows[style].blur
//     property int offsetY: themeManager.currentTheme.shadows[style].offsetY
//     property real intensity: 1.5          // 阴影强度系数
//     property real spreadRatio: 1        // 阴影扩散系数
//     property real controlRadius: 8         // 控制半径
//     readonly property color shadowColor: themeManager.currentTheme.shadows[style].color
//
